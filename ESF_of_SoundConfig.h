...
#ifndef ESF_of_SoundConfig_H
#define ESF_of_SoundConfig_H
...
namespace ESF_of_SoundConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 20013;
}

#endif // ESF_of_SoundConfig_H
