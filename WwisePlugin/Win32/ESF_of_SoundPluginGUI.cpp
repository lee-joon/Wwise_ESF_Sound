...
#include "ESF_of_SoundPluginGUI.h"

ESF_of_SoundPluginGUI::ESF_of_SoundPluginGUI()
{
}

ADD_AUDIOPLUGIN_CLASS_TO_CONTAINER(
    ESF_of_Sound,            // Name of the plug-in container for this shared library
    ESF_of_SoundPluginGUI,   // Authoring plug-in class to add to the plug-in container
